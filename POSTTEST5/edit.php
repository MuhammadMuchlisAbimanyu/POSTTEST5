...
if (isset($_POST["tambah"])) {
    $name_cst = htmlspecialchars($_POST["name_mhs"]);
...
<body>
    ...
    <section class='admin'>
        <div class="view-admin-tambah">
            ...
            <input class="form-admin-element" type="text" name="name" value="<?php echo $opc["name_cst"]; ?>"><br><br>
            <label for="phone_number_cst">Costumer Phone Number : </label>
            ...
            <label for="email_cst">Costumer Email : </label>
